...
/**
 * Comprehensive unit tests for RegisterUserRequest DTO.
 * 
 * These tests verify all validation logic, behavior, and edge cases
 * implemented in the RegisterUserRequest DTO.
 * 
 * Test Coverage:
...
class RegisterUserRequestTest {
    ...
    class ConstructorTests {
        ...
        void shouldCreateRequestWithAllArgsConstructor() {
            ...
            // When
            request = new RegisterUserRequest(firstName, lastName, email, password, role);
        ...
        void shouldCreateRequestWithNullValuesInAllArgsConstructor() {
            // When
            request = new RegisterUserRequest(null, null, null, null, null);
    ...
    class ValidationTests {
        ...
        void shouldValidateRequestWithValidData() {
            // Given
            request = new RegisterUserRequest("John", "Doe", "john.doe@example.com", "password123", "CUSTOMER");
        ...
        void shouldFailValidationWithNullFirstName() {
            // Given
            request = new RegisterUserRequest(null, "Doe", "john@example.com", "password123", "CUSTOMER");
        ...
        void shouldFailValidationWithEmptyFirstName() {
            // Given
            request = new RegisterUserRequest("", "Doe", "john@example.com", "password123", "CUSTOMER");
        ...
        void shouldFailValidationWithFirstNameTooShort() {
            // Given
            request = new RegisterUserRequest("J", "Doe", "john@example.com", "password123", "CUSTOMER");
        ...
        void shouldFailValidationWithFirstNameTooLong() {
            ...
            request = new RegisterUserRequest(longFirstName, "Doe", "john@example.com", "password123", "CUSTOMER");
        ...
        void shouldFailValidationWithNullLastName() {
            // Given
            request = new RegisterUserRequest("John", null, "john@example.com", "password123", "CUSTOMER");
        ...
        void shouldFailValidationWithEmptyLastName() {
            // Given
            request = new RegisterUserRequest("John", "", "john@example.com", "password123", "CUSTOMER");
        ...
        void shouldFailValidationWithNullEmail() {
            // Given
            request = new RegisterUserRequest("John", "Doe", null, "password123", "CUSTOMER");
        ...
        void shouldFailValidationWithInvalidEmailFormat() {
            // Given
            request = new RegisterUserRequest("John", "Doe", "invalid-email", "password123", "CUSTOMER");
        ...
        void shouldFailValidationWithNullPassword() {
            // Given
            request = new RegisterUserRequest("John", "Doe", "john@example.com", null, "CUSTOMER");
        ...
        void shouldFailValidationWithPasswordTooShort() {
            // Given
            request = new RegisterUserRequest("John", "Doe", "john@example.com", "short", "CUSTOMER");
        ...
        void shouldFailValidationWithNullRole() {
            // Given
            request = new RegisterUserRequest("John", "Doe", "john@example.com", "password123", null);
        ...
        void shouldFailValidationWithMultipleConstraintViolations() {
            // Given
            request = new RegisterUserRequest("", "", "invalid-email", "short", null);
    ...
    class NameLengthValidationTests {
        ...
        void shouldAcceptFirstNameWithMinimumValidLength() {
            // Given
            request = new RegisterUserRequest("Jo", "Doe", "john@example.com", "password123", "CUSTOMER");
        ...
        void shouldAcceptFirstNameWithMaximumValidLength() {
            ...
            request = new RegisterUserRequest(maxLengthFirstName, "Doe", "john@example.com", "password123", "CUSTOMER");
        ...
        void shouldAcceptLastNameWithMinimumValidLength() {
            // Given
            request = new RegisterUserRequest("John", "Do", "john@example.com", "password123", "CUSTOMER");
        ...
        void shouldAcceptLastNameWithMaximumValidLength() {
            ...
            request = new RegisterUserRequest("John", maxLengthLastName, "john@example.com", "password123", "CUSTOMER");
    ...
    class EmailFormatValidationTests {
        ...
        void shouldAcceptValidEmailFormats() {
            ...
            for (String validEmail : validEmails) {
                request = new RegisterUserRequest("John", "Doe", validEmail, "password123", "CUSTOMER");
                Set<ConstraintViolation<RegisterUserRequest>> violations = validator.validate(request);
        ...
        void shouldRejectInvalidEmailFormats(String invalidEmail) {
            // Given
            request = new RegisterUserRequest("John", "Doe", invalidEmail, "password123", "CUSTOMER");
    ...
    class PasswordLengthValidationTests {
        ...
        void shouldAcceptPasswordWithMinimumValidLength() {
            // Given
            request = new RegisterUserRequest("John", "Doe", "john@example.com", "12345678", "CUSTOMER");
        ...
        void shouldAcceptPasswordLongerThanMinimumLength() {
            ...
            request = new RegisterUserRequest("John", "Doe", "john@example.com", longPassword, "CUSTOMER");
        ...
        void shouldRejectPasswordShorterThan8Characters(String shortPassword) {
            // Given
            request = new RegisterUserRequest("John", "Doe", "john@example.com", shortPassword, "CUSTOMER");
    ...
    class EdgeCasesAndErrorConditions {
        ...
        void shouldHandleNamesWithSpecialCharacters() {
            // Given
            request = new RegisterUserRequest("Jean-Pierre", "O'Connor", "jean@example.com", "password123", "CUSTOMER");
        ...
        void shouldHandleNamesWithUnicodeCharacters() {
            // Given
            request = new RegisterUserRequest("José", "García", "jose@example.com", "password123", "CUSTOMER");
        ...
        void shouldHandlePasswordWithSpecialCharacters() {
            ...
            request = new RegisterUserRequest("John", "Doe", "john@example.com", specialPassword, "CUSTOMER");
        ...
        void shouldHandleRoleWithSpecialCharacters() {
            // Given
            request = new RegisterUserRequest("John", "Doe", "john@example.com", "password123", "ADMIN-USER");
    ...
    class ObjectBehaviorTests {
        ...
        void shouldNotBeEqualWhenAllFieldsAreTheSame() {
            ...
            RegisterUserRequest request1 = new RegisterUserRequest(firstName, lastName, email, password, role);
            RegisterUserRequest request2 = new RegisterUserRequest(firstName, lastName, email, password, role);
        ...
        void shouldNotBeEqualToNull() {
            // Given
            request = new RegisterUserRequest("John", "Doe", "john@example.com", "password123", "CUSTOMER");
    ...
    class StringRepresentationTests {
        ...
        void shouldReturnMeaningfulStringRepresentation() {
            ...
            assertThat(result).contains("RegisterUserRequest");
    ...
    class SecurityAndPrivacyTests {
        ...
        void shouldNotExposePasswordInToString() {
            ...
            request = new RegisterUserRequest("John", "Doe", "john@example.com", sensitivePassword, "CUSTOMER");
    ...
    class IntegrationAndWorkflowTests {
        ...
        @Test
        @DisplayName("Should handle complete user registration request workflow")
        void shouldHandleCompleteUserRegistrationRequestWorkflow() {
            // Given
            String firstName = "John";
            String lastName = "Doe";
            String email = "john.doe@example.com";
        ...
        void shouldHandleRequestModificationWorkflow() {
            // Given
            request = new RegisterUserRequest("Old", "Name", "old@example.com", "oldpassword", "OLD_ROLE");
